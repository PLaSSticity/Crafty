...
# ARG2 - ACCOUNTS
# ARG3 - THREADS
set output sprintf("|ps2pdf -dEPSCrop - test_BACKWARD_X.pdf")
...
set title sprintf("bank (Nb. accounts=%s, THREADS=%s)", ARG2, ARG3)
...
plot NVHTM1 using 1:6:($6-$13):($6+$13) title "NVHTM_B 0.01" with yerrorbars lc 1, \
