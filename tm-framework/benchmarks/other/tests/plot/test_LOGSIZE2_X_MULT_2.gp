...
# ARG1 - FOLDER HIGH
# ARG2 - FOLDER LOW
set output sprintf("|ps2pdf -dEPSCrop - test_X_MULT_2.pdf")
...
### TODO:
unset xlabel
set key at graph 1.80,0.98 right Left reverse maxcols 2 maxrows 4 width 4.5 \
  font ",18" samplen 2.5 spacing 1

set ylabel "Throughput ({/*0.8 x10}^6 TXs/s)" font ",23" offset 1.55,0.0
