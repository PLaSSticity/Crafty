...
int_stm_start(stm_tx_t *tx, stm_tx_attr_t attr, sigjmp_buf *buf)
{
...
int_stm_commit(stm_tx_t *tx)
{
  ...
  // TODO: flush number of writes
  int nb_flushes = tx->w_set.nb_entries; // logged entries
#endif
