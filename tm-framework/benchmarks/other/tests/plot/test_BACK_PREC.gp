...
# ARG2 - ACCOUNTS
# ARG3 - THREADS
set output sprintf("|ps2pdf -dEPSCrop - test_BACKWARD_BLOCKED_R%s.pdf", ARG4)
...
plot NVHTM1 using 1:7:($7-$15):($7+$15) title "NVHTM_B 0.01" with yerrorbars lc 1, \
  NVHTM1    using 1:7                 notitle with lines lc 1, \
  NVHTM2    using 1:7:($7-$15):($7+$15) title 'NVHTM_B 0.05' with yerrorbars lc 2, \
  NVHTM2    using 1:7                 notitle with lines lc 2, \
  NVHTM3    using 1:7:($7-$15):($7+$15) title 'NVHTM_B 0.1' with yerrorbars lc 3, \
  NVHTM3    using 1:7                 notitle with lines lc 3, \
  NVHTM4    using 1:7:($7-$15):($7+$15) title 'NVHTM_B 0.5' with yerrorbars lc 4, \
  NVHTM4    using 1:7                 notitle with lines lc 4, \
  NVHTM_F   using 1:7:($7-$15):($7+$15) title 'NVHTM_F' with yerrorbars lc 5, \
  NVHTM_F   using 1:7                 notitle with lines lc 5, \
  NVHTM_W   using 1:7:($7-$15):($7+$15) title 'NVHTM_W' with yerrorbars lc 6, \
  NVHTM_W   using 1:7                 notitle with lines lc 6, \
  PHTM      using 1:7:($7-$15):($7+$15) title 'PHTM' with yerrorbars lc 7, \
